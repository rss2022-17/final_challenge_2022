...
PTS_IMAGE_PLANE = [[380, 227],
                   [372, 204],
                   [505, 227],
                   [465, 205]] # dummy points
######################################################
...
######################################################
## DUMMY POINTS -- ENTER YOUR MEASUREMENTS HERE
PTS_GROUND_PLANE = [[32, 0],
                    [44, 0],
                    [32, -12],
                    [44, -12]] #From cutting mat
######################################################
...
class HomographyTransformer:
    def __init__(self):
        ...
        self.test_click_sub = rospy.Subscriber("/zed/zed_node/left/image_rect_color_mouse_left", ConeLocationPixel, self.click_detection_callback)
